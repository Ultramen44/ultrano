...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/Ultramen44/ultrano/refs/heads/main/"
...
clear
izinsc="https://raw.githubusercontent.com/Ultramen44/permision/refs/heads/main/ultrano"
# USERNAME
rm -f /usr/bin/user
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"t.me/Ultranenstor"}]]}' 
...
bash -c "$(curl -L https://github.com/XTLS/Xray-install/raw/main/install-release.sh)" @ install -u www-data --version $latest_version
    ...
    sudo curl -fsSL https://raw.githubusercontent.com/Ilham24022001/ganteng/refs/heads/main/config/nginx.conf -o /etc/nginx/nginx.conf
...
wget -q https://raw.githubusercontent.com/Ultramen44/ultrano/refs/heads/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
...
wget -q -O /etc/default/dropbear https://raw.githubusercontent.com/Ultramen44/ultrano/refs/heads/main/config/dropbear.conf
...
#OpenVPN
wget https://raw.githubusercontent.com/Ultramen44/ultrano/refs/heads/main/config/openvpn && chmod +x openvpn && ./openvpn
...
# Ganti Banner
wget -O /etc/kyt.txt https://raw.githubusercontent.com/Ultramen44/ultrano/refs/heads/main/files/issue.net
...
echo "------------------------------------------------------------"
echo ""
echo "===============-[ SCRIPT BY WONG NDEZO ]-==============="
echo -e ""
echo ""
echo "" | tee -a log-install.txt
echo "Semuanya Berjalan Ok...Terimakasih Telah menggunakan Script WONG NDEZO!!"
sleep 1
